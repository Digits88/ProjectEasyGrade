 ...
 */
class Submission extends \NSEPBundle\Entity\Submission implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'NSEPBundle\\Entity\\Submission' . "\0" . 'id', '' . "\0" . 'NSEPBundle\\Entity\\Submission' . "\0" . 'imageFile', '' . "\0" . 'NSEPBundle\\Entity\\Submission' . "\0" . 'imageName', '' . "\0" . 'NSEPBundle\\Entity\\Submission' . "\0" . 'updatedAt', '' . "\0" . 'NSEPBundle\\Entity\\Submission' . "\0" . 'assignment', '' . "\0" . 'NSEPBundle\\Entity\\Submission' . "\0" . 'status', '' . "\0" . 'NSEPBundle\\Entity\\Submission' . "\0" . 'sphereengineid', '' . "\0" . 'NSEPBundle\\Entity\\Submission' . "\0" . 'language', '' . "\0" . 'NSEPBundle\\Entity\\Submission' . "\0" . 'submissionmarks'];
        }
    ...
    public function setSphereengineid($sphereengineid)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSphereengineid', [$sphereengineid]);

        return parent::setSphereengineid($sphereengineid);
    }
    ...
    public function getSphereengineid()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSphereengineid', []);

        return parent::getSphereengineid();
    }
    ...
    public function setSubmissionmarks($submissionmarks)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSubmissionmarks', [$submissionmarks]);

        return parent::setSubmissionmarks($submissionmarks);
    }
    ...
    public function getSubmissionmarks()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSubmissionmarks', []);

        return parent::getSubmissionmarks();
    }
