...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('submission_image', $c, $a, $b));
        $d->addEventSubscriber(new \FOS\UserBundle\Doctrine\UserListener($this));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('submission_image', $c, $a, $b));
        $d->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('submission_image', $c, $a, $b));
        $d->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'easygrade', 'user' => 'root', 'password' => 'qwerty', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $d, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_d98213b0c09583546ed76fc5ed1e375bd63667dfa0151376a2b7a8520f13073b');
    ...
    public function getVichUploader_DownloadHandlerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['vich_uploader.download_handler'] = new VichUploaderBundleHandlerDownloadHandler_00000000502d3deb000000009ec12fec59fd32ce8da54f549709ff4670e09a3a(
    ...
    public function getVichUploader_UploadHandlerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['vich_uploader.upload_handler'] = new VichUploaderBundleHandlerUploadHandler_00000000502d3de8000000009ec12fec59fd32ce8da54f549709ff4670e09a3a(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
...
class VichUploaderBundleHandlerDownloadHandler_00000000502d3deb000000009ec12fec59fd32ce8da54f549709ff4670e09a3a extends \Vich\UploaderBundle\Handler\DownloadHandler implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder5759235287fa5945582416 = null;
    private $initializer575923528805a293231380 = null;
    private static $publicProperties5759235287dbf797255802 = array(
        
    );
    public function downloadObject($object, $field, $className = null, $fileName = null)
    {
        $this->initializer575923528805a293231380 && $this->initializer575923528805a293231380->__invoke($this->valueHolder5759235287fa5945582416, $this, 'downloadObject', array('object' => $object, 'field' => $field, 'className' => $className, 'fileName' => $fileName), $this->initializer575923528805a293231380);
        return $this->valueHolder5759235287fa5945582416->downloadObject($object, $field, $className, $fileName);
    }
    public function __construct($initializer)
    {
        $this->initializer575923528805a293231380 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer575923528805a293231380 && $this->initializer575923528805a293231380->__invoke($this->valueHolder5759235287fa5945582416, $this, '__get', array('name' => $name), $this->initializer575923528805a293231380);
        if (isset(self::$publicProperties5759235287dbf797255802[$name])) {
            return $this->valueHolder5759235287fa5945582416->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5759235287fa5945582416;
    ...
    {
        $this->initializer575923528805a293231380 && $this->initializer575923528805a293231380->__invoke($this->valueHolder5759235287fa5945582416, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer575923528805a293231380);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5759235287fa5945582416;
    ...
    {
        $this->initializer575923528805a293231380 && $this->initializer575923528805a293231380->__invoke($this->valueHolder5759235287fa5945582416, $this, '__isset', array('name' => $name), $this->initializer575923528805a293231380);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5759235287fa5945582416;
    ...
    {
        $this->initializer575923528805a293231380 && $this->initializer575923528805a293231380->__invoke($this->valueHolder5759235287fa5945582416, $this, '__unset', array('name' => $name), $this->initializer575923528805a293231380);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5759235287fa5945582416;
    ...
    {
        $this->initializer575923528805a293231380 && $this->initializer575923528805a293231380->__invoke($this->valueHolder5759235287fa5945582416, $this, '__clone', array(), $this->initializer575923528805a293231380);
        $this->valueHolder5759235287fa5945582416 = clone $this->valueHolder5759235287fa5945582416;
    }
    public function __sleep()
    {
        $this->initializer575923528805a293231380 && $this->initializer575923528805a293231380->__invoke($this->valueHolder5759235287fa5945582416, $this, '__sleep', array(), $this->initializer575923528805a293231380);
        return array('valueHolder5759235287fa5945582416');
    }
    ...
    {
        return $this->initializer575923528805a293231380;
    }
    public function initializeProxy()
    {
        return $this->initializer575923528805a293231380 && $this->initializer575923528805a293231380->__invoke($this->valueHolder5759235287fa5945582416, $this, 'initializeProxy', array(), $this->initializer575923528805a293231380);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder5759235287fa5945582416;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5759235287fa5945582416;
    }
}

class VichUploaderBundleHandlerUploadHandler_00000000502d3de8000000009ec12fec59fd32ce8da54f549709ff4670e09a3a extends \Vich\UploaderBundle\Handler\UploadHandler implements \ProxyManager\Proxy\VirtualProxyInterface
{
    private $valueHolder5759235299a9e644497570 = null;
    private $initializer5759235299b4f031802285 = null;
    private static $publicProperties5759235299950275413436 = array(
        
    );
    public function upload($obj, $fieldName)
    {
        $this->initializer5759235299b4f031802285 && $this->initializer5759235299b4f031802285->__invoke($this->valueHolder5759235299a9e644497570, $this, 'upload', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5759235299b4f031802285);
        return $this->valueHolder5759235299a9e644497570->upload($obj, $fieldName);
    }
    public function inject($obj, $fieldName)
    {
        $this->initializer5759235299b4f031802285 && $this->initializer5759235299b4f031802285->__invoke($this->valueHolder5759235299a9e644497570, $this, 'inject', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5759235299b4f031802285);
        return $this->valueHolder5759235299a9e644497570->inject($obj, $fieldName);
    }
    public function clean($obj, $fieldName)
    {
        $this->initializer5759235299b4f031802285 && $this->initializer5759235299b4f031802285->__invoke($this->valueHolder5759235299a9e644497570, $this, 'clean', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5759235299b4f031802285);
        return $this->valueHolder5759235299a9e644497570->clean($obj, $fieldName);
    }
    public function remove($obj, $fieldName)
    {
        $this->initializer5759235299b4f031802285 && $this->initializer5759235299b4f031802285->__invoke($this->valueHolder5759235299a9e644497570, $this, 'remove', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer5759235299b4f031802285);
        return $this->valueHolder5759235299a9e644497570->remove($obj, $fieldName);
    }
    public function __construct($initializer)
    {
        $this->initializer5759235299b4f031802285 = $initializer;
    }
    public function & __get($name)
    {
        $this->initializer5759235299b4f031802285 && $this->initializer5759235299b4f031802285->__invoke($this->valueHolder5759235299a9e644497570, $this, '__get', array('name' => $name), $this->initializer5759235299b4f031802285);
        if (isset(self::$publicProperties5759235299950275413436[$name])) {
            return $this->valueHolder5759235299a9e644497570->$name;
        }
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5759235299a9e644497570;
            $backtrace = debug_backtrace(false);
            trigger_error('Undefined property: ' . get_parent_class($this) . '::$' . $name . ' in ' . $backtrace[0]['file'] . ' on line ' . $backtrace[0]['line'], \E_USER_NOTICE);
            return $targetObject->$name;;
            return;
    ...
    public function __set($name, $value)
    {
        $this->initializer5759235299b4f031802285 && $this->initializer5759235299b4f031802285->__invoke($this->valueHolder5759235299a9e644497570, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5759235299b4f031802285);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5759235299a9e644497570;
            return $targetObject->$name = $value;;
    ...
    public function __isset($name)
    {
        $this->initializer5759235299b4f031802285 && $this->initializer5759235299b4f031802285->__invoke($this->valueHolder5759235299a9e644497570, $this, '__isset', array('name' => $name), $this->initializer5759235299b4f031802285);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5759235299a9e644497570;
            return isset($targetObject->$name);;
    ...
    public function __unset($name)
    {
        $this->initializer5759235299b4f031802285 && $this->initializer5759235299b4f031802285->__invoke($this->valueHolder5759235299a9e644497570, $this, '__unset', array('name' => $name), $this->initializer5759235299b4f031802285);
        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));
        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5759235299a9e644497570;
            unset($targetObject->$name);;
    ...
    public function __clone()
    {
        $this->initializer5759235299b4f031802285 && $this->initializer5759235299b4f031802285->__invoke($this->valueHolder5759235299a9e644497570, $this, '__clone', array(), $this->initializer5759235299b4f031802285);
        $this->valueHolder5759235299a9e644497570 = clone $this->valueHolder5759235299a9e644497570;
    }
    public function __sleep()
    {
        $this->initializer5759235299b4f031802285 && $this->initializer5759235299b4f031802285->__invoke($this->valueHolder5759235299a9e644497570, $this, '__sleep', array(), $this->initializer5759235299b4f031802285);
        return array('valueHolder5759235299a9e644497570');
    }
    public function __wakeup()
    {
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer5759235299b4f031802285;
    }
    public function initializeProxy()
    {
        return $this->initializer5759235299b4f031802285 && $this->initializer5759235299b4f031802285->__invoke($this->valueHolder5759235299a9e644497570, $this, 'initializeProxy', array(), $this->initializer5759235299b4f031802285);
    }
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder5759235299a9e644497570;
    }
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder5759235299a9e644497570;
    }
}
